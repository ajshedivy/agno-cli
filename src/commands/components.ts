...
export const componentCommand = new Command("component").description("Manage components");
...
// -- component config (nested) -----------------------------------------------

const configSubCommand = new Command("config").description("Manage component configurations");
